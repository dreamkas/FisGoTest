...
public class CashTest {
    ...
    public static final String CashboxIP = "192.168.243.12";
    ...
    private Vector<String> instruction_table = new Vector<>();
...
*/
    ...
    private int registration(List <String> keyWordArray) {
        ...
        if (compare) {
            ...
            System.out.println("registrationData clc addr = " + registrationData);
            if (registrationData.equals("CANNOT FIND KEYWORD")) {
            ...
            System.out.println("registrationData clc place = " + registrationData);
            if (registrationData.equals("CANNOT FIND KEYWORD")) {
            ...
            System.out.println("registrationData reg num = " + registrationData);
            if (registrationData.equals("CANNOT FIND KEYWORD")) {
...
/*
    ...
    public int strToKeypadConvert(String str) {
       ...
       // tcpSocket.setFlagPause(true,1);
        ...
        //    System.out.println("---------in testKeypadAllScreen-----------");
        keypad_mode = tcpSocket.getKeypadMode();
        System.out.println("keypadMode = " + keypad_mode);
        // System.out.println("keypad_mode = " + keypad_mode);
...
public class CashTest {
    ...
    private static final String CashBoxType = "DreamkasF"; //DreamkasRF
    private static final String CashboxIP = "192.168.242.87";//7";//2.68";
    ...
    public void before_test_clear_cashbox() {
        ...
        keyEnum.initKeyEnum();
        tcpSocket.setFlagGetScreen(true);//.setFlagReceiveScreen(true);
        tcpSocket.createSocket(CashboxIP, CashboxPort);
        manager.initSession(CashboxIP, USERNAME, PORT, PASSWORD);
        ...
        if (!line.get(0).equals("2")) {
            ...
            switch (testResult) {
                case -1:
                    ...
                    break;
                case -2:
                    fail("Пустой ИНН в пункте регистрации.\nЗавершить регистрацию невмозможно.");
                    break;
                case -3:
                    fail("Пустое наименование организации в пункте регистрации.\nЗавершить регистрацию невмозможно.");
                    break;
