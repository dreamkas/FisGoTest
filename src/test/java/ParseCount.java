public class ParseCount {
    public static final int ID = 0,
            ...
            REALIZATION_TOTAL = 23,             //меняется при любых операциях
            REPORT_CNT = 24,
            ...
            RET_CONSUMPTION_CARD = 31,          //меняется при возврате расхода электронными
            RET_CONSUMPTION_CARD_CNT = 32,      //меняется при возврате расхода электронными
